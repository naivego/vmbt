...
class MatStrategy(CtaTemplate):
    ...
    def __init__(self, ctaEngine, setting):
        ...
        self.vada0 = Barda(trdvar, 'Dom_'+ctaEngine.miniT)
        # ---------
        try:
            ...
            if var == '':
                var = trdvar
            self.vada1 = Barda(var, 'Dom_'+barp)
        except:
            self.vada1 = None
        #---------
        try:
            ...
            if var == '':
                var = trdvar
            self.vada2 = Barda(var, 'Dom_'+barp)
        except:
            self.vada2 = None
        # ---------
        try:
            ...
            if var == '':
                var = trdvar
            self.vada3 = Barda(var, 'Dom_' + barp)
        except:
            self.vada3 = None
...
if __name__ == '__main__':
    ...
    btconfig['Start_Date'] = '2011-01-01'
    btconfig['End_Date'] = '2015-03-30'
    ...
    setting = {}
    # ---------数据列表设置
    setting['vada1'] = {'var': '', 'period': 'M75'}
    setting['vada2'] = {'var': '', 'period': 'M115'}
