...
def showspds( ):
    ...
    #-------------------------cross----------
    vada1 = load_Dombar(trdvar, period, Time_Param, DB_Rt_Dir, Dom='CrossContract', Adj=False)
    vada2 = load_Dombar(trdvar, period, Time_Param, DB_Rt_Dir, Dom='CrossContract2', Adj=False)
